...
CMD_CONFIG_REPLACE="wget https://raw.githubusercontent.com/g105b/github-deploy/master/replace-config.php && php replace-config.php $DEPLOY_CONFIG_PATH $TMPDIR/$CIRCLE_PROJECT_REPONAME"
